...
namespace BjjTrainer_API.Migrations
{
    ...
    [Migration("20241206055214_UpdateCalendarEventDates")]
    partial class UpdateCalendarEventDates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BjjTrainer_API.Models.Users.TrainingLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BjjTrainer_API.Models.Joins.TrainingLogMove", b =>
                {
                    ...
                    b.HasOne("BjjTrainer_API.Models.Users.TrainingLog", "TrainingLog")
                        .WithMany("TrainingLogMoves")
