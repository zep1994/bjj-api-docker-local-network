...
namespace BjjTrainer_API.Migrations
{
    ...
    [Migration("20241115150403_UpdateTrainingSession")]
    partial class UpdateTrainingSession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BjjTrainer_API.Models.Training_Sessions.TrainingSession", b =>
                {
                    ...
                    b.Property<List<string>>("AressOfImprovement")
                        .HasColumnType("text[]");
                    ...
                    b.Property<List<int>>("MovesTrained")
                        .HasColumnType("integer[]");
